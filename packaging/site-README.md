...
Use Debian 12+ or Ubuntu 22.04+ with systemd, root/sudo, Python 3.9+ and Bash. DNS and filing must be complete, with TCP 80/443 reachable. Existing Caddy must be 2.10+; missing runtime packages are installed from apt. No Git checkout or TOML parser is needed.
